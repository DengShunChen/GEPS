      subroutine sortml_gpu(jtrun, mlmax, msort, lsort, mlsort, jtrun_max, mlmax_max)
!
...
!
         implicit none
         integer jtrun, mlmax, jtrun_max, mlmax_max
         integer msort(mlmax_max), lsort(mlmax_max), mlsort(jtrun_max, jtrun_max)
