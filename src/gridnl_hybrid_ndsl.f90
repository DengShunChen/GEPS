...
!
      ...
      real(kind=RTYPE) diveng(nx,lev),vdmerd(nx,lev),vdzonl(nx,lev), &
                ...
                rdiv(nx,lev),ut(nx,lev),vt(nx,lev)
!
      real      sdpbl(nx)
      logical   flag(nx)
!
...
!CWB2021 for single precision test
      ...
      subroutine gridnl_hybrid_ndsl_sp ( nxj,nx,lev,ncld             &
                        , cp,radsq,ut,vt,rdiv,tt,qt,phi,pt           &
                        , dtpl,dlpl,sinl,pk,pk2,dsigma,sigma,onocos  &
                        , cor,diveng,vdmerd,vdzonl,pten,deldm,sdpbl  &
                        , sd,pdot,sgeo)
...
!
      ...
      real      ut(nx,lev),vt(nx,lev),tt(nx,lev)                  &
      , qt(nx,lev*ncld),pt(nx),pk(nx,lev)                         &
...
!
!----------------------------------------------------------------------
      subroutine gridnl_hybrid_ndsl_2tl_sp ( nxj,nx,lev,ncld         &
                        , cp,radsq,ut,vt,rdiv,tt,qt,phi,pt           &
                        , dtpl,dlpl,sinl,pk,pk2,dsigma,sigma,onocos  &
                        , cor,diveng,vdmerd,vdzonl,pten,deldm,sdpbl  &
                        , sd,pdot,sgeo,step)
