...
!  local array
!
      real      glob1(nx,my),glob2(nx,my),glob3(nx,my)
!
...
!
      ...
      call mpe2d_unify(glob,gwet)
      do 36 j=1,my
       nxj=nxdef(j)
      do 36 i=1,nxj
        glob(i,j)=glob(i,j)/20.
 36   continue
...
!
      call mpe2d_unify(glob1,raincu)
      call mpe2d_unify(glob2,rainlp)
...
!
      ...
      call mpe2d_unify(glob1,ss)
      call mpe2d_unify(glob2,rs)
      do j=1,my
       nxj=nxdef(j)
      do i=1,nxj
        glob(i,j)=glob1(i,j)-glob2(i,j)
...
!
      ...
      call mpe2d_unify(glob,wk_xy(1,1,1))
...
!
      ...
      call mpe2d_unify(glob,wk_xy(1,1,2))
...
!
      ...
      call mpe2d_unify(glob,wk_xy(1,1,3))
...
!
      ...
      call mpe2d_unify(glob,wk_xy(1,1,4))
...
! output 10-200cm
      ...
      call mpe2d_unify(glob1,soil_xy(1,1,2))
      call mpe2d_unify(glob2,soil_xy(1,1,3))
      call mpe2d_unify(glob3,soil_xy(1,1,4))
      do j=1,my
       nxj=nxdef(j)
      do i=1,nxj
       glob(i,j)=glob1(i,j)*sfac2+glob2(i,j)*sfac3 &
                  +glob3(i,j)*sfac4
      end do
      end do
...
! 10-200cm
      ...
      call mpe2d_unify(glob1,soil_xy(1,1,6))
      call mpe2d_unify(glob2,soil_xy(1,1,7))
      call mpe2d_unify(glob3,soil_xy(1,1,8))
      do j=1,my
       nxj=nxdef(j)
      do i=1,nxj
       glob(i,j)=glob1(i,j)*sfac2+glob2(i,j)*sfac3 &
...
! 0-10cm
      ...
      call mpe2d_unify(glob,soil_xy(1,1,9))
...
!10-40cm
      ...
      call mpe2d_unify(glob,soil_xy(1,1,10))
...
! 40-100cm
      ...
      call mpe2d_unify(glob,soil_xy(1,1,11))
...
! 100-200cm
      ...
      call mpe2d_unify(glob,soil_xy(1,1,12))
...
! 10-200cm
      ...
      call mpe2d_unify(glob1,soil_xy(1,1,10))
      call mpe2d_unify(glob2,soil_xy(1,1,11))
      call mpe2d_unify(glob3,soil_xy(1,1,12))
      do j=1,my
       nxj=nxdef(j)
      do i=1,nxj
       glob(i,j)=glob1(i,j)*sfac2+glob2(i,j)*sfac3 &
...
! ctot_total cloud fraction
      ...
      call mpe2d_unify(glob,wk_xy(1,1,6))
...
! chig_high cloud fraction
      ...
      call mpe2d_unify(glob,wk_xy(1,1,7))
...
! cmid_middle cloud fraction
      ...
      call mpe2d_unify(glob,wk_xy(1,1,8))
...
! clow_low cloud fraction
      ...
      call mpe2d_unify(glob,wk_xy(1,1,9))
...
! pbl hight
      ...
      call mpe2d_unify(glob,wk_xy(1,1,10))
...
! specific humidity 
      ...
      call mpe2d_unify(glob,wk_xy(1,1,11))
...
!
      ...
      call mpe2d_unify(glob,wk_xy(1,1,12))
