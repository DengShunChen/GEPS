...
!
      ...
      use rank
      use index
      use const ,only:aki,bki ,out_pres_form ,ifilout_grb
      ...
      real      sgeo(nxp,my_max),pt(nxp,my_max),plt(nxp,lev,my_max)      &
              ...
              , ss(nxp,my_max),pk(nxp,lev,my_max),rh0(nxp,my_max)        &
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      ...
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,3,0,2,103,0,hm(mm),glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,1,0,6,103,0,hm(mm),glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,1,22,8,103,0,hm(mm),glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,2,2,2,103,0,hm(mm),glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,2,3,2,103,0,hm(mm),glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2(itau,0,0,0,2,103,0,hm(mm),glob)
      endif
!-----------------------------------------------------------------------
      enddo  ! end (mm)
!=======================================================================
...
!output 1hr prec. at tau=0
      ...
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      !elseif(out_pres_form==2.and.myrank==0)then
      !  call wrt_grb2_accu(itau,0,1,7,2,1,0,0.,1,1,glob)
      endif
      endif
!output 6hr prec.
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      ...
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2_accu(itau,0,1,10,2,1,0,0.,1,6,glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      ...
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2_accu(itau,0,1,9,2,1,0,0.,1,6,glob)
      endif
...
!byl      call dmswrit(nx,my,ihdg,lenc,'H',ifilout,glob,istat)
      ...
      if(out_pres_form==1)then
        call split(nx,my,lev,lenc,ifilout,nc,glob,mout,ihdg,ihdg2)
      elseif(out_pres_form==2.and.myrank==0)then
        call wrt_grb2_accu(itau,0,1,7,2,1,0,0.,1,6,glob)
      endif
