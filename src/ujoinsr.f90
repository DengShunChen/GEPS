...
!CWB2021 for single precision test
      ...
      subroutine ujoinsr_sp(cc,r1,r2,r3,r4,nx,my_max,lev,jlistnum,num,ncld)
!
      implicit  none
      real*4      cc(*), r1(*), r2(*), r3(*), r4(*)
      integer   nx,my_max,lev,jlistnum,num,ncld
!
      if(num .eq. 1) call ujoin1sr_sp(cc,r1,nx,my_max,lev           &
                                  ,jlistnum,ncld)
      if(num .eq. 2) call ujoin2sr_sp(cc,r1,r2,nx,my_max,lev        &
                                  ,jlistnum,ncld)
      if(num .eq. 3) call ujoin3sr_sp(cc,r1,r2,r3,nx,my_max,lev     &
                                  ,jlistnum,ncld)
      if(num .eq. 4) call ujoin4sr_sp(cc,r1,r2,r3,r4,nx,my_max,lev  &
                                  ,jlistnum,ncld)
!
      return
      end
!
      subroutine ujoin1sr_sp(cc,r1,nx,my_max,lev,jnum,ncld)
!
!     include '../include/index.h'
      use index
      ...
      real*4      bufA(nx,levp,ncld,my_max)
      real*4      bufB(nxp,lev,ncld,my_max)
      integer   nx,my_max,lev,jnum,ncld
      integer   jj,j,nxj,k,i,nk,kk,n
!
      do jj=1,jlistnum
      ...
      call mpe2d_transpose_nx_levp_sp(bufA,bufB,nxp,nx,lev,levp,ncld,myf,my_max,jlistnum,jlen,nsizex,row_comm)
...
!
      subroutine ujoin2sr_sp(cc,r1,r2,nx,my_max,lev,jnum,ncld)
!     include '../include/index.h'
      use index
      ...
      real*4      bufA(nx,levp,1+ncld,my_max)
      real*4      bufB(nxp,lev,1+ncld,my_max)
      integer   nx,my_max,lev,jnum,ncld
      integer   jj,j,nxj,k,i,nk,kk,n
!
      do jj=1,jlistnum
      ...
      call mpe2d_transpose_nx_levp_sp(bufA,bufB,nxp,nx,lev,levp,1+ncld,myf,my_max,jlistnum,jlen,nsizex,row_comm)
...
!
      subroutine ujoin3sr_sp(cc,r1,r2,r3,nx,my_max,lev,jnum,ncld)
!
!     include '../include/index.h'
      use index
      ...
      real*4      bufA(nx,levp,2+ncld,my_max)
      real*4      bufB(nxp,lev,2+ncld,my_max)
      integer   nx,my_max,lev,jnum,ncld
      integer   jj,j,nxj,k,i,nk,kk,n
!
      do jj=1,jlistnum
      ...
      call mpe2d_transpose_nx_levp_sp(bufA,bufB,nxp,nx,lev,levp,2+ncld,myf,my_max,jlistnum,jlen,nsizex,row_comm)
...
!
      ...
      subroutine ujoin4sr_sp(cc,r1,r2,r3,r4,nx,my_max,lev,jnum,ncld)

!     include '../include/index.h'
      use index

      implicit  none
      real*4      cc(nx+2,levp,3+ncld,my_max)
      real*4      r1(nxp,lev,my_max)
      real*4      r2(nxp,lev,my_max)
      real*4      r3(nxp,lev,my_max)
      real*4      r4(nxp,lev*ncld,my_max)
      real*4      bufA(nx,levp,3+ncld,my_max)
      real*4      bufB(nxp,lev,3+ncld,my_max)
      integer   nx,my_max,lev,jnum,ncld
      integer   jj,j,nxj,k,i,nk,kk,n
!
      do jj=1,jlistnum
      ...
      call mpe2d_transpose_nx_levp_sp(bufA,bufB,nxp,nx,lev,levp,3+ncld,myf,my_max,jlistnum,jlen,nsizex,row_comm)
