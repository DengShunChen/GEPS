...
!CWB2021 for single precision test
      ...
      subroutine trandv_sp (jtrun,jtmax,nx,my,my_max,lev,ut,vt,w,cim  &
                        ,onocos,poly,dpoly,vor,div,nsize)
!
!  subroutine to do grid point velocities to spectral vorticity
!  and divergence
...
!
      ...
      real(kind=RTYPE)      wcc5(levp,2,2,my/2)
!
      real(kind=RTYPE)      wp(my/2,jtrun),wd(my/2,jtrun),dummy
...
!2dMPI
      call joinrs_sp(cc,ut,vt,dummy,dummy,nx,my_max,lev,jlistnum,2,1)
