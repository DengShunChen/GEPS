      SUBROUTINE SFC_SICE(imj,IM,KM,PS,U1,V1,T1,Q1,                   &
...
!                       CMM,CHH,ZLVL, 
!lu_q2m_iter [-1L/+1L]: add flag_iter 
!*                      EVAP,HFLX,EP,DDVEL) 
...
!
          call qsatq(1, tice(i), psurf(i)*0.01, qssi(i))
!
!         qssw(i) = fpvs(tgice) 
!         QSSW(I) = EPS * QSSW(I) / (PSURF(I) + EPSM1 * QSSW(I)) 
!
          call qsatq(1, tgice, psurf(i)*0.01, qssw(i))
!
! 
...
!         hfd = Heat flux derivat @ surface 
!             = 4 emissivity T**3 + RCH [ 1 + L/CP * DQS/DT) ] 
...
!CC...QC END 
        ENDIF 
      ENDDO 
      call ice3lay(imj,IM,kmi,snowd,hice,fice,flag,    &
...
! 
      ...
      SUBROUTINE ICE3LAY(imj,IM,kmi,hs,hi,fice,flag,  &
...
! *************************************************************** 
!                                                               * 
!    Argument    Description            Units       Changed?    * 
!    --------    -----------            -----       --------    * 
!                                                               * 
! INPUT/OUTPUT:                                                 * 
!                                                               * 
!      hs       Snow Thickness           m               y      * 
!      hi       Ice Thickness            m               y      * 
!      ts       Surface Temperature      deg C           y      * 
!      ti(1)    Temp @ Midpt of Ice1     deg C           y      * 
!      ti(2)    Temp @ Midpt of Ice2     deg C           y      * 
!      hf(+)    Net non-solar and upIR                          * 
!               heat flux @ surface      watt/m^2        n      * 
!      sol(+)   Net solar incoming top   watt/m^2        n      * 
!      hfd(+)   Heat flux derivat @ sfc  watt/(m^2deg-C) n      * 
!      fb(+)    Heat Flux from Ocean     watt/m^2        n      * 
!      snow     Snowfall Rate            m/sec           n      * 
!      dt       timestep                 sec             n      * 
!                                                               * 
! ADDITIONAL:                                                   * 
!                                                               * 
!      snowmt   snow melt during dt      m               y      * 
!      gflux    conductive heat flux     watt/m^2        y      * 
!      flag     Ice mask flag                            n      * 
!                                                               * 
! LOCAL:                                                        * 
!                                                               * 
!      hdi      ice-water interface      m               y      * 
!      hsni     snow-ice                 m               y      * 
! *************************************************************** 
! 
      integer              IM, kmi,imj 
...
! 
! variables for temperature calculation [see Winton (2000) 2.a] 
! 
...
! properties of ice, snow, and seawater (local) 
