...
#
# Usage:
#   find_package(DMS [REQUIRED] [QUIET])
#     
# It sets the following variables:
#   DMS_FOUND               ... true if DMS is found on the system; if false, you cannot build anything that requires DMS
#   DMS_INCLUDE_DIR         ... DMS include directory where to locate DMS.h file
#   DMS_LIBRARY             ... full path to DMS library to link against to use DMS
#
# The following variables will be checked by the function
#   DMS_USE_STATIC_LIBS    ... if true, only static libraries are found
...
foreach( _lib IN ITEMS rdms gdbm )
  ...
  #find DMS library
  find_library(DMS_LIBRARY_${_lib} NAMES ${_lib} PATHS
    ${DMS_ROOT}/lib
    $ENV{DMS_ROOT}/lib
    ${DMS_ROOT}/lib64
    $ENV{DMS}
