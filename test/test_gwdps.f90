...
subroutine gwdps_unit
   ...
   real :: dvdtc(nxp,lev,my_max),  dudtc(nxp,lev,my_max),  dtdtc(nxp,lev,my_max),       &
           ...
           prsl(nxp,lev,my_max),   prslk(nxp,lev,my_max),  phii(nxp,lev+1),      &
           phil(nxp,lev,my_max)
   ...
   do i = 1, 16
     ...
     do jj = 1, jlistnum
       ...
       call gwdps(nxjp(j), nxp, nxp, lev, dvdtc(1,1,jj), dudtc(1,1,jj), dtdtc(1,1,jj),             &
                  ...
                  del(1,1,jj), prsl(1,1,jj), prslk(1,1,jj), phii, phil(1,1,jj), dta, kdt,  &
