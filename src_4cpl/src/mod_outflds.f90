...
!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,wk1,istat)
      ...
      ptp0(7)=nint(plev(k))
      call split2(nx,my,lenc,ifilout,ncnt,wk1,pout,ihdg,ihdg2,ptp0,ptp1)
      go to 20
      endif
   10 continue
   20 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,11,6,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,wk1,istat)
   ...
   20 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,196,6,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,slp,istat)
      ...
      ptp0(7)=nint(plev(k))
      call split2(nx,my,lenc,ifilout,ncnt,slp,pout,ihdg,ihdg2,ptp0,ptp1)
!
      go to 20
      endif
   10 continue
   20 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,3,5,1,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
      ...
      ptp0(7)=nint(plev(k))
      call split2(nx,my,lenc,ifilout,ncnt,glob,pout,ihdg,ihdg2,ptp0,ptp1)
      go to 30
      endif
   10 continue
   30 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,1,1,2,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
      call qmaxn3(glob,ihdg(1:14),ihdg(15:26),1,1,1,nx,my,1)
      gtp0(7)=nint(plev(k))
      call split2(nx,my,lenc,ifilout,ncnt,glob,pout,ihdg,ihdg2,gtp0,gtp1)
      go to 30
      endif
   10 continue
   30 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,Ptp0,Ptp1,Ptp2,Ptp3,100,-2,gtp1(7),pout,ihdg2)
      endif
!
   40 continue
...
!
   ...
   30 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,6,32,3,100,-2,ptp1(7),pout,ihdg2)
      endif
!
   40 continue
...
!
      ...
      if(label(kk).eq.'SSL010' .or. label(kk).eq.'ssl010') then
        ...
        if(outgrb2==1.and.myrank==0)then
          call wrt_grb2_v2(itau,0,3,1,2,101,0,0,glob,lrec)
        endif
...
!byl        if( lreduce.eq.1 ) call reduceintp (glob,nxdef,nx,my)
        if(lwrite) call dmswrit(nx,my,lrec,lenc,kflag,ifilout,glob,istat)
        if(outgrb2==1.and.myrank==0)then
          call wrt_grb2_v2(itau,0,3,0,2,103,0,0,glob,lrec)
        endif
        call qmaxn3(glob,lrec(1:14),lrec(15:26),1,1,1,nx,my,1)
...
!!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
   ...
   30 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,0,0,2,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,wk1,istat)
   ...
   20 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,12,6,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
...
!!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
   ...
   30 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,2,2,100,-2,ptp1(7),pout,ihdg2)
      endif
!
...
!!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
   ...
   40 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,3,2,100,-2,ptp1(7),pout,ihdg2)
      endif
!
...
!      if(lwrite) call dmswrit(nx,my,ihdg,lenc,kflag,ifilout,glob,istat)
   ...
   42 continue
      ...
      if(outgrb2 == 1 )then
      if(lwrite .and. myrank .lt. ncnt ) &
        call wrt_grb2_v2(itau,0,2,8,6,100,-2,ptp1(7),pout,ihdg2)
      endif
!
      return
